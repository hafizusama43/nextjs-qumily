                ...
                {org_dashboard ?
                    ...
                    <>
                        <Link href="/" className='flex items-center'>
                            ...
                            <span className='font-bold hidden md:block'>Qumily</span>
                        </Link>
                        <div className="flex items-center">
                            {mounted && <div className="flex items-center mr-2 md:mr-4">
                            ...
                            {isSignedIn && <Link href="/campaigns"><Button className='mr-1 md:mr-4' variant="secondary">Campaigns</Button></Link>}
                            {isSignedIn && <span className="ml-1 md:ml-2 flex items-center"><UserButton afterSignOutUrl="/" userProfileMode="navigation" userProfileUrl="/user-profile"></UserButton></span>}
                        </div>
                    </>}
            </div>
        </div>
