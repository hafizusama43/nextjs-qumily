...
import { z } from 'zod'
import { BIDDING_STRATEGY, CAMPAIGN_STATE, getSpecificKeyValues, getStepName, SPC_HELP_TEXT, SPONSORED_PRODUCTS_CAMPAIGNS, TARGETING_STRATEGY, TARGETING_TYPE } from '@/lib/helpers'
        ...
        <div>
            <Form {...form}>
                <form onSubmit={form.handleSubmit(onSubmit)} className="w-full space-y-6">
                    ...
                    <div className="block md:flex gap-5">
                        <div className='basis-1/2 w-full'>
                            <RenderInput name={"campaign_id"} helpText={SPC_HELP_TEXT.campaign_id} form={form} label={SPONSORED_PRODUCTS_CAMPAIGNS.campaign_id}></RenderInput>
                        </div>
                        <div className='basis-1/2 w-full'>
                            <RenderInput name={"campaign_name"} helpText={SPC_HELP_TEXT.campaign_name} form={form} label={SPONSORED_PRODUCTS_CAMPAIGNS.campaign_name}></RenderInput>
                        </div>
                    </div>

                    <div className="block md:flex gap-5">
                        <div className='basis-1/2 w-full'>
                            <RenderDatePicker name={"start_date"} helpText={SPC_HELP_TEXT.start_date} label={SPONSORED_PRODUCTS_CAMPAIGNS.start_date} form={form}></RenderDatePicker>
                        </div>
                        <div className='basis-1/2 w-full'>
                    ...
                    <div className="block md:flex gap-5">
                        ...
                        <div className='basis-1/2 w-full'>
                            <RenderSelect name={"state"} helpText={SPC_HELP_TEXT.state} form={form} options={CAMPAIGN_STATE} label={SPONSORED_PRODUCTS_CAMPAIGNS.state}></RenderSelect>
                        </div>
                        <div className='basis-1/2 w-full'>
                            <RenderInput name={"daily_budget"} helpText={SPC_HELP_TEXT.budget} form={form} label={SPONSORED_PRODUCTS_CAMPAIGNS.daily_budget} type={"number"}></RenderInput>
                        </div>
                    </div>

                    <div className="block md:flex gap-5">
                        <div className='basis-1/2 w-full'>
                            <RenderSelect name={"bidding_strategy"} helpText={SPC_HELP_TEXT.bidding_strategy} form={form} options={BIDDING_STRATEGY} label={SPONSORED_PRODUCTS_CAMPAIGNS.bidding_strategy}></RenderSelect>
                        </div>
