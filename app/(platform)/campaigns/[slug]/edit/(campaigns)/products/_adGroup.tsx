                ...
                <form onSubmit={form.handleSubmit(onSubmit)} className="w-full space-y-6">
                    <div className="block md:flex gap-5">
                        <div className='basis-1/2 w-full'>
                            <RenderInput name={"ad_group_id"} helpText={SPC_HELP_TEXT.ad_group_id} form={form} label={SPONSORED_PRODUCTS_CAMPAIGNS.ad_group_id}></RenderInput>
                        </div>
                        <div className='basis-1/2 w-full'>
                            <RenderInput name={"ad_group_name"} helpText={SPC_HELP_TEXT.ad_group_name} form={form} label={SPONSORED_PRODUCTS_CAMPAIGNS.ad_group_name}></RenderInput>
                        </div>
                    </div>

                    <div className="block md:flex gap-5">
                        <div className='basis-1/2 w-full'>
                            <RenderInput name={"ad_group_default_bid"} helpText={SPC_HELP_TEXT.ad_group_default_bid} form={form} label={SPONSORED_PRODUCTS_CAMPAIGNS.ad_group_default_bid} type={"number"}></RenderInput>
                        </div>
                    </div>
