...
export default function Home() {
  return (
    <div className='flex flex-col items-center justify-center h-full'>
      ...
      <h1 className='mt-10 text-2xl md:text-5xl uppercase'>Qumily helps team move</h1>
      <p className='bg-gradient-to-r from-orange-300 to-orange-600 p-5 mt-10 rounded-lg text-xl md:text-4xl uppercase dark:text-black'>forward efficiently.</p>
